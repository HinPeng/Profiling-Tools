...
source /home/fanyang/v-wencxi/GDR_TF/bin/activate
#machines=("10.0.0.19" "10.0.0.20" "10.0.0.23" "10.0.0.25")
machines=("10.0.0.19" "10.0.0.23")
...
#    echo 3 | sudo tee /proc/sys/vm/drop_caches
    RDMA_DEVICE=mlx5_0 RDMA_PORT=1 ./dis_run_perf.sh $1 $2 $3 $4 $5 $6 $7 $8 $9
}
